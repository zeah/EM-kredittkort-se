...
final class Kkse_overview {
	...
	public function add_menu() {
		add_submenu_page('edit.php?post_type=emkredittkortse', 'Overview', 'Overview', 'manage_options', 'emkredittkortse-overview', array($this, 'add_page'));
	}

	public function add_page() {
		wp_enqueue_style('em-kredittkort-se-admin-style', KREDITTKORT_SE_PLUGIN_URL . 'assets/css/admin/em-kredittkort-se.css', array(), '1.0.1');
