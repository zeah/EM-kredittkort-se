...
require_once 'kkse-taxonomy.php';
require_once 'kkse-edit.php';
require_once 'kkse-overview.php';

/**
 * 
 */
final class Kkse_posttype {
	/* singleton */
	...
	private function __construct() {
		Kkse_edit::get_instance();
		Kkse_taxonomy::get_instance();
		Kkse_overview::get_instance();
	...
	*/
	public function create_cpt() {
		...
		$args = array(
			...
			'taxonomies'          => array('emkredittkortsetype'),
			'public'              => false,
			'show_ui'             => true,
			'show_in_menu'        => true,
		...
		register_post_type('emkredittkortse', $args);
	}
}